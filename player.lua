local motion = {
  ...
  function motion.updFunc(dt)
    local bPressed = lovr.headset.wasPressed('right', "b")

    if bPressed then
        -- jump goes brrrrrrrrrrrrrrr (joking, just put the same nextbot jump code but in the player)
